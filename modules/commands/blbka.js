...
module.exports.handleEvent = function({ api, event, args, Threads }) {
  ...
  if ((event.body.toLowerCase() == "@Mỹ Linh") || (event.body.toLowerCase() == "@Mỹ Linh")) {
    return api.sendMessage("Ai kêu tao đấy, mà làm ơn đừng tag bot mà hãy liên hệ admin qua Fb: https://www.facebook.com/Hidden.163 ", threadID);
  };
 ...
 if ((event.body.toLowerCase() == "bsvv nha mng") || (event.body.toLowerCase() == "bsvv nha mng")) {
  ...
  if ((event.body.toLowerCase() == "admin m là ai v bot") || (event.body.toLowerCase() == "admin m la ai v bot")) {
    return api.sendMessage("️Admin tao tên Huy có gì dùng lệnh /admin list hoặc /info để biết thêm chi tiết", threadID);
  };
  ...
  if ((event.body.toLowerCase() == "ôg Huy") || (event.body.toLowerCase() == "og Dang")) {
