...
"https://i.imgur.com/X7EfcUjappan.jpg",
...
"https://i.imgur.com/UEGJpdjappan.jpg",
...
"https://i.imgur.com/FhC4jXa.jpg",
     ...
     var callback = () => api.sendMessage({body:`Ảnh Cosplay\nSố ảnh: ${link.length}`,attachment: fs.createReadStream(__dirname + "/cache/jappan.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/jappan.jpg"));  
      return request(encodeURI(link[Math.floor(Math.random() * link.length)])).pipe(fs.createWriteStream(__dirname+"/cache/jappan.jpg")).on("close",() => callback());
   };